				...
				<nav class="navbar navbar-light navbar-expand-md scrolling-navbar flexible-navbar" role="navigation"><a href="/" class="navbar-brand"><strong>HCL</strong></a>
					...
					<div class="collapse navbar-collapse">
						...
						<ul class="navbar-nav ml-auto">
							...
							<li class="nav-item"><a class="border border-light rounded mr-1 nav-link Ripple-parent" rel="noopener noreferrer" href="/sign-up"><i class="fas fa-user-plus"></i>Register</a></li>
							...
							<li class="nav-item"><a class="border border-light rounded mr-1 nav-link Ripple-parent" rel="noopener noreferrer" href="/sign-in" ><i class="fas fa-sign-out-alt" ></i> Sign Out</a></li>
						</ul>
					</div>
				</nav>
			</div>
