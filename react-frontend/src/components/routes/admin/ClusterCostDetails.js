			...
			<div className="outer">
				<div className="inner">
					...
					<div class="button-group mb-3">
						<button type="button" style={{textTransform: 'none'}} onClick={this.back} className="btn btn-light float-left" rounded="true">Back</button>
						<button type="button" style={{textTransform: 'none'}} onClick={this.continue} disabled={!isEnabled} className="btn btn-dark float-right" rounded="true">Continue</button>
					</div>
				</div></div>
